...
namespace InstaChef.Migrations
{
    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Recipe",
                columns: new[] { "Id", "CookingDifficulty", "CreatorId", "CuisineType", "DateCreated", "MealType", "Name", "Preparation", "PreparationTime", "ServingCount" },
                values: new object[,]
                {
                    { 1, "Beginner", 1, "American", new DateOnly(2024, 12, 11), "Breakfast", "Pancakes", "Mix ingredients and cook on a skillet until golden brown.", 20, 4 },
                    { 2, "Intermediate", 2, "Italian", new DateOnly(2024, 12, 11), "Lunch", "Tomato Soup", "Blend tomatoes and simmer with spices.", 30, 3 }
                });
